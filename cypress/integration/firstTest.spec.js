...
describe('Our first suite', () => {
    ...
    it('web tables', () => {
        ...
        cy.get('thead').find('tr').eq(2).then(tableRow => {
            ...
            cy.wrap(tableRow).find('[placeholder="First Name"]').type('Ezgi')
            cy.wrap(tableRow).find('[placeholder="Last Name"]').type('Taner')
            cy.wrap(tableRow).find('.nb-checkmark').click()
        ...
        cy.get('tbody tr').first().find('td').then(tableColumns => {
            ...
            cy.wrap(tableColumns).eq(2).should('contain', 'Ezgi')
            cy.wrap(tableColumns).eq(3).should('contain', 'Taner')
        })
